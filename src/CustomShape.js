...
export function Shapes({ count,offset }) {
  ...
  const particles = useMemo(() => {
    ...
    for (let i = 0; i < count; i++) {
      const factor =  generateRandomPointInSphericalShell(25, 50)
  ...
  return (
    <instancedMesh ref={mesh} args={[null, null, count]} scale ={0.2} >
      <primitive object={nodes.Circle.geometry} /> {/* Replace 'YourGeometryNodeName' with the actual name of your geometry node */}
